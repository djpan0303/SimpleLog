 ...
 */
#ifdef ERROR
#ifdef SIMPLELOG_FIX_ERROR_COLLISION
...
#undef ERROR
    static const int ERROR = SimpleLog::_tmpERRORValue;
#define ERROR ERROR

#else  // SIMPLELOG_FIX_ERROR_COLLISION
#error Naming collision for 'ERROR' detected. Please read the FAQ for a \
       workaround. 
#endif // SIMPLELOG_FIX_ERROR_COLLISION 
